...
public class BsimLRANBatch_KGB extends TorTestCaseHelper implements TestCase {
    ...
    protected static BsimRemoteCommandExecutor bsimSshRemoteCommandExecutor = BsimApiGetter.getRemoteCommandExecutor(BsimApiGetter.getHostMaster());
    ...
    public void prepareTheRun() {
        bsimSshRemoteCommandExecutor.simpleExec("smtool -coldrestart OsgiFwk -reason=upgrade -reasontext='Upgrade of ERICbsim'\r");
        try {
            Thread.sleep(120000);
        } catch (final InterruptedException e) {
            // TODO Auto-generated catch block (Nov 30, 2016:7:05:37 AM by xbhawpr)
        ...
        log = Logger.getLogger(BsimLRANBatch_KGB.class);
        assertTrue(new PreCheckRegisteredService().doPreCheck(null));
